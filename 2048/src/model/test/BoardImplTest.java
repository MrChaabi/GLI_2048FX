...
import fr.istic.gli.javafx.model.Direction;
...
public class BoardImplTest {
    ...
    public void testPackIntoDirection1() throws Exception {
        ...
        testBoard.packIntoDirection(Direction.LEFT);
        testBoard.commit();
    ...
    */
    ...
    public void testPackIntoDirection10() throws Exception {
        ...
        testBoard.packIntoDirection(Direction.RIGHT);
        testBoard.commit();
    ...
    public void testPackIntoDirection20() throws Exception {
        ...
        testBoard.packIntoDirection(Direction.TOP);
        testBoard.commit();
        Assert.assertNotNull(testBoard.getTile(1, 1));
    ...
    public void testPackIntoDirection30() throws Exception {
        ...
        testBoard.packIntoDirection(Direction.BOTTOM);
        testBoard.commit();
